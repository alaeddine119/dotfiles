...
# Loop indefinitely providing raw JSON lines to Waybar
while true; do
  # ==========================================
  # 1. FAST UPDATES (Every 1 second)
  # ==========================================

  # --- Keyboard Layout Stub (Handled natively or via Niri IPC later) ---
  layout_text=""
  ...
  # ==========================================
  # 3. ULTRA SLOW UPDATES (Every 5min)
  # ==========================================
  ...
  # ==========================================
  # 4. WEATHER UPDATES (Asynchronous)
  # ==========================================
  ...
  # Output flat JSON line structure for Waybar
  printf '{"text": "%s"}\n' "$safe_output"
